...
export default function NavBar() {
  return (
    <div className="bg-black h-28 top-0 left-0 right-0 z-50 content-center w-screen">
        <nav className="text-white text-[20px] flex justify-between px-16">
          <div className="">
          ...
          <div className="content-center">
            ...
            <span className="gap-3 flex">
              <input 
                type="text" 
                className="w-48 text-black px-2"
                placeholder="ค้นหา"
              />
              <div className="w-10 h-10 bg-zinc-900 p-[5px]"><button><Search /></button></div>
            </span>
          </div>
          </div>
        </nav>
