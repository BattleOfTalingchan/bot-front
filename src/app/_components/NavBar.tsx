...
export default function NavBar() {
  return (
    <div className="bg-black h-28 top-0 left-0 right-0 z-50 content-center">
        <nav className="text-white text-[20px] flex justify-between px-[60px]">
          ...
          <div className="flex space-x-8 h-10 content-center">
            <a href="" className="content-center">รายชื่อการ์ด</a>
            <a href="" className="content-center">กฎกติกา</a>
            <span className="gap-3 flex content-center">
              <input 
                type="text" 
